...
public class CustomerDashboardController {
    ...
    public void initialize() {
        ...
        activeButton = shopBtn;
        
        // Load Shop view directly on startup (instead of welcome screen)
        showShop();
        
        System.out.println("Shop view loaded automatically on customer login");
    }
    ...
    /**
     * Show Shop View (Stones Grid)
     */
    @FXML
    private void showShop() {
        setActiveButton(shopBtn);
        loadView("/fxml/customer_shop_view.fxml");
    }
    ...
    private void showOrders() {
        ...
        loadView("/fxml/customer_orders_view.fxml");
    }
    ...
    private void showProfile() {
        ...
        loadView("/fxml/customer_profile_view.fxml");
    }

    /**
     * Show Custom Orders View
     */
    @FXML
    private void showCustomOrders() {
        setActiveButton(customOrdersBtn);
        loadView("/fxml/customer_custom_orders_view.fxml");
    }
